package com.framecast.streamer.consent
 ...
 * before [com.framecast.streamer.rewards.AdMobAdController.initialize] is
...
class ConsentManager(private val activity: Activity) {
    ...
    /** Must be true before [com.framecast.streamer.rewards.AdController.preload] is ever called. */
