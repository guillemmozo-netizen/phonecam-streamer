package com.framecast.streamer.streaming.gl
 ...
 * [com.framecast.streamer.streaming.StreamingVideoOutput]) as a
 ...
 * — see [com.framecast.streamer.streaming.H264Encoder].
 */
class EncoderSurfaceRenderer(inputSurface: Surface, private val targetWidth: Int, private val targetHeight: Int) {
    ...
    private fun uploadWatermarkTexture() {
        val overlay = com.framecast.streamer.overlay.WatermarkOverlay.renderOverlay(targetWidth, targetHeight)
        GLES20.glActiveTexture(GLES20.GL_TEXTURE0)
        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, watermarkTextureId)
