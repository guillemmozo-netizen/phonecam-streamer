...
import com.framecast.streamer.audio.AudioLevelMeter
import com.framecast.streamer.consent.ConsentManager
import com.framecast.streamer.databinding.ActivityMainBinding
import com.framecast.streamer.camera2.Camera2Capabilities
import com.framecast.streamer.camera2.Camera2CaptureSource
import com.framecast.streamer.device.DeviceCapabilities
import com.framecast.streamer.device.DeviceModelDatabase
import com.framecast.streamer.network.PcControl
import com.framecast.streamer.network.PcDiscovery
import com.framecast.streamer.rewards.AdMobAdController
import com.framecast.streamer.rewards.RewardManager
import com.framecast.streamer.streaming.CameraStreamer
import com.framecast.streamer.ui.AppToast
import com.framecast.streamer.ui.WelcomeDialog
import org.json.JSONObject
import java.util.concurrent.Executors
import kotlin.math.roundToInt
import com.framecast.streamer.streaming.RotationDebouncer
import com.framecast.streamer.streaming.RotationPolicy
...
class MainActivity : AppCompatActivity() {
    ...
    // the phone is turned.
    private var currentVideoCapture: VideoCapture<com.framecast.streamer.streaming.StreamingVideoOutput>? = null
    ...
    private var camera2Source: com.framecast.streamer.camera2.Camera2CaptureSource? = null
    ...
    private val mainVideoOutput = com.framecast.streamer.streaming.StreamingVideoOutput { request ->
    ...
    private fun applyPhysicalCameraId(
        builder: VideoCapture.Builder<com.framecast.streamer.streaming.StreamingVideoOutput>,
        physicalCameraId: String?,
        fpsRange: android.util.Range<Int>?,
    ) {
        val extender = Camera2Interop.Extender(builder)
